...
import com.pae.well.repository.ProjectRepository;
import com.pae.well.service.ProjectService;
...
/**
 * REST controller for managing {@link com.pae.well.domain.Project}.
 */
@RestController
@RequestMapping("/api")
public class ProjectResource {
    ...
    private static final String ENTITY_NAME = "wellProject";
