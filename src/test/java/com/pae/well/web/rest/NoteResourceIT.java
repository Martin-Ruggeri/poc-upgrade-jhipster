...
import com.pae.well.repository.NoteRepository;
import com.pae.well.service.dto.NoteDTO;
import com.pae.well.service.mapper.NoteMapper;
...
class NoteResourceIT {
    ...
    public static Note createEntity(EntityManager em) {
        Note note = new Note().idUser(DEFAULT_ID_USER).description(DEFAULT_DESCRIPTION).date(DEFAULT_DATE);
        // Add required entity
        Well well;
    ...
    public static Note createUpdatedEntity(EntityManager em) {
        Note note = new Note().idUser(UPDATED_ID_USER).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
        // Add required entity
        Well well;
        if (TestUtil.findAll(em, Well.class).isEmpty()) {
    ...
    void createNote() throws Exception {
        ...
        assertThat(testNote.getIdUser()).isEqualTo(DEFAULT_ID_USER);
    ...
    void putExistingNote() throws Exception {
        ...
        updatedNote.idUser(UPDATED_ID_USER).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
        ...
        Note testNote = noteList.get(noteList.size() - 1);
        assertThat(testNote.getIdUser()).isEqualTo(UPDATED_ID_USER);
    ...
    void partialUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.idUser(UPDATED_ID_USER);
    ...
    void fullUpdateNoteWithPatch() throws Exception {
        ...
        partialUpdatedNote.idUser(UPDATED_ID_USER).description(UPDATED_DESCRIPTION).date(UPDATED_DATE);
